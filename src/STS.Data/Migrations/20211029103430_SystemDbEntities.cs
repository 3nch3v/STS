...
{
    public partial class SystemDbEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeesTasks_Priorities_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "Priorities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeesTasks_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeesTasks_IsDeleted",
                table: "EmployeesTasks",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeesTasks_PriorityId",
                table: "EmployeesTasks",
                column: "PriorityId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeesTasks_StatusId",
                table: "EmployeesTasks",
                column: "StatusId");
